...
export default function Login1() {
  return (
    <div className="flex h-screen items-center justify-center bg-gray-200">
      <div className="flex h-4/5 w-3/5 justify-center">
        <div className="relative w-6/12 rounded-l-md bg-yellow-300 shadow-lg">
          <Image
            src="/bg-login1.png"
            alt="login 1"
            fill
        ...
        <div className="w-5/12 rounded-r-md bg-white px-10 py-14 shadow-lg">
